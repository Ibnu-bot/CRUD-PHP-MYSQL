    ...
    <div class="card">
        ...
        <?php
                ...
                if (isset($_GET['kode_kategori'])) {
                    ...
                    $sql="DELETE FROM kategori where kode_kategori='$kode_kategori' ";
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                <thead>
                    ...
                    <?php
                            include("../../perpuscoba/koneksi.php");
                            $sql="SELECT * FROM kategori order by kode_kategori asc";
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?kode_kategori=<?php echo($data['kode_kategori']); ?>"
                                class="btn btn-warning" role="button">Edit</a>
                            <a href="<?php echo ($_SERVER["PHP_SELF"]);?>?kode_kategori=<?php echo $data['kode_kategori']; ?>"
