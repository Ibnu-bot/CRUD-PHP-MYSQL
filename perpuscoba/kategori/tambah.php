...
<body>
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $koko = mysqli_num_rows(mysqli_query($kon, "SELECT * FROM kategori WHERE kode_kategori=$kode_kategori"));
            ...
            ('$kode_kategori','$nama_kategori')";
                ...
                if ($hasil) {
                    header("Location:../kategori/index.php?pesan=Data Berhasil Disimpan");
                } else {
                    header("Location:../kategori/index.php?pesan=Data Gagal Disimpan");
                }
            }
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" name="kode_kategori" class="form-control" placeholder="Masukan Kode Kategori"
                    required />
            </div>
            <div class="form-group">
