        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                <thead>
                    ...
                    <?php
                        $no = 1;
                        $ih = mysqli_query($kon, "SELECT * FROM buku INNER JOIN kategori ON kategori.kode_kategori=buku.kode_kategori");
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?kode_buku=<?php echo($data['kode_buku']); ?>" class="btn btn-warning"
                                role="button">Edit</a>
                            <a href="<?php echo ($_SERVER["PHP_SELF"]);?>?kode_buku=<?php echo $data['kode_buku']; ?>"
